...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import KaHyPar_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("87a0c12d-51e1-52a8-b1ed-2b00825fe6a4"))
platforms = [Pkg.Artifacts.unpack_platform(e, "KaHyPar", artifacts_toml) for e in artifacts["KaHyPar"]]
...
if best_platform === nothing
    @debug("Unable to load KaHyPar; unsupported platform $(triplet(platform_key_abi()))")
else
